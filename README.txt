...
5: To generate the xls report the url is:
    http://host:port/{Reportingcontext}/xls/employee or http://host:8080/Reporting/xls/customers


6: To generate the pdf report the url is:
   http://host:port/{Reportingcontext}/pdf/employee or http://host:8080/Reporting/pdf/customers
